...
value_box(
  ...
  theme = "light" # Cloak of the Undead King: 501 items sold. Unfortunately I haven't find a good way to add captions, it does not fit properly, especially using value property
)
```

### Row - Plot - Mean shop-level sales by engagement approach {height=38%}
